...
public class Viaggio {
	...
	public String toString() {
		return codice + ", " + destinazione + ", " + durata + ", " + numPasseggeri;
	}
	...
	public boolean equals(Object o) {
		...
		Viaggio v = (Viaggio)o;
		if (this.codice.equals(v.codice) && this.destinazione.equals(v.destinazione) && this.durata == v.durata && this.numPasseggeri == v.numPasseggeri)
			return true;
		return false;
	}
